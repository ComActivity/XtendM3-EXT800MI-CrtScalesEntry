...
public class AddAttributes extends ExtendM3Transaction {
  ...
  if (atid.equals("CHM04")) {
    Map<String, String> params = ["JOB": "EXT851", "TX30": "UpdateComments", "XCAT": "010", "SCTY": "1", "XNOW": "1", "UUID": referenceId]; // ingle run - now
    miCaller.call("SHS010MI", "SchedXM3Job", params, { result -> });
    } else {
      Map<String, String> params = ["JOB": "EXT850", "TX30": "AddAttributes", "XCAT": "010", "SCTY": "1", "XNOW": "1", "UUID": referenceId]; // ingle run - now
      miCaller.call("SHS010MI", "SchedXM3Job", params, { result -> });
    }
  }
  /*
